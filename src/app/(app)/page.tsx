...
import { TextGenerateEffect } from '@/components/utils/TextGenerateEffect';
    ...
    <main className={'h-full'}>
      ...
      <div className={'mx-auto h-full grid-cols-2 items-center lg:grid'}>
        <div className={'flex flex-col items-start p-4 lg:p-20'}>
          ...
          <p className={'mb-4'}>
            Whether you’re questioning your relationship with alcohol,
            processing trauma or navigating major life transitions, this is a
            space for you to lay it all down.
          </p>
